...
from inferencer.vgg import vgg, init_weights
...
class MODEL_CRAFT(nn.Module):
    def __init__(self, pretrained=False, freeze=False):
        super(MODEL_CRAFT, self).__init__()

        """ Base network """
        self.basenet = vgg(pretrained, freeze)
...
class MODEL_REFINE_NET(nn.Module):
    def __init__(self):
        super(MODEL_REFINE_NET, self).__init__()
